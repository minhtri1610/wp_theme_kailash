...
<section class="container mt-[1em]" id="insight">
    ...
    <?php if (!empty($posts)): ?>
        ...
        <div class="wapper-insight grid grid-cols-1 md:grid-cols-3 gap-4 md:h-[400px] lg:h-[500px]">
            ...
            <?php if (isset($posts[0])):
                ...
                ?>
                <div class="left-insight col-span-1 md:col-span-2 h-[300px] md:h-full">
    ...
    <?php else: ?>
        ...
        <div class="wapper-insight grid grid-cols-1 md:grid-cols-3 gap-4 md:h-[400px] lg:h-[500px]">
            ...
            <div class="right-insight grid grid-rows-2 gap-4 h-full">
                <div
                    class="w-full h-[250px] md:h-full bg-gray-200 flex items-center justify-center row-span-2 text-center p-4">
                    Please add "Insight" posts in Admin</div>
            </div>
        </div>
