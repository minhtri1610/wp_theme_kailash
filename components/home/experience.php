            ...
            <div class="content-experience h-full flex flex-col justify-center">
                ...
                <div class="content-info text-black py-2 md:py-5 text-base text-left md:text-justify leading-relaxed">
                    ...
                    $exp_pages = get_posts(array(
                        ...
                        'meta_value' => 'archive-experience.php',
                        'fields' => 'ids',
                        'lang' => pll_current_language(),
                    ));
                    echo !empty($exp_pages) ? get_the_excerpt($exp_pages[0]) : '';
                    ?>
                </div>

                <div class="flex justify-start items-end link mt-4 md:mt-5">
                    <a href="<?php echo site_url('/dich-vu'); ?>"
                        class="text-[#125f4b] font-semibold hover:underline flex items-center gap-2">
        ...
        <div class="col-span-1 lg:col-span-2">
            ...
            <div class="content-experience grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-2 h-full">
                ...
                <div class="col-span-1 md:col-span-2 h-full">
                    <img class="w-full h-[300px] md:h-full object-cover rounded-lg md:rounded-none"
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/home/experience/practices_pc.jpg"
                        alt="">
                </div>
                ...
                <div class="col-span-1 md:col-span-3 flex flex-col justify-between h-full">
                    ...
                    <a class="count-knowledge block group" href="<?php echo site_url('/kien-thuc'); ?>">
                        <h2
                            class="text-3xl md:text-4xl font-bold text-black mb-2 md:mb-6 text-center md:text-left group-hover:text-[#125f4b] transition-colors">
                            <?php pll_e('Kiến thức'); ?>
                        </h2>

                        <p class="text-center md:text-right">
                            <span
                                class="text-[#125f4b] font-gilda text-8xl md:text-8xl lg:text-[10rem] leading-none block md:inline-block"
                    ...
                    <a class="img-knowledge mt-4 md:mt-0 block overflow-hidden rounded-lg md:rounded-none"
                        href="<?php echo site_url('/kien-thuc'); ?>">
                        <img class="w-full h-[200px] md:h-auto object-cover hover:scale-105 hover:opacity-80 transition-all duration-500"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/home/experience/knowledge_pc.jpg"
                            alt="">
                    </a>
                </div>
