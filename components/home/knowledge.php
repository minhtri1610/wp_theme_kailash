            ...
            <div class="kn-items">
                    ...
                    <?php if ($knowledge_query->have_posts()): ?>
                        <?php while ($knowledge_query->have_posts()):
                            ...
                            <div class="kn-item flex flex-col border-b border-gray-300 py-3 md:py-4 last:border-0">
                                <a class="text-[#0e0e0e] hover:text-[#125f4b] text-lg md:text-base font-medium md:font-normal leading-snug capitalize"
                                ...
                                <?php if ($sub_exps): ?>
                                    <div class="kn-list-sub flex flex-wrap mt-1 md:mt-0">
                                        ...
                                        foreach ($sub_exps as $sub_id):
                                            ...
                                            ?>
                                            <span
                                                class="border rounded-xl outline-1 border-[#125f4b] px-2 py-0.5 md:py-0 my-1 md:my-2 text-xs md:text-sm text-[#125f4b]">
                ...
                <div class="kn-footer flex justify-end mt-4 md:mt-3">
                    <a href="<?php echo esc_url($cat_link); ?>"
                        class="text-black text-sm md:text-base hover:text-[#125f4b] transition-colors">
