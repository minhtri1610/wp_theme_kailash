...
<div class="wapper-list-member">
    <div class="container mx-auto px-4 c-list-member mb-12">
        ...
        <div class="content-list-member">
            ...
            <div
                class="wapper-search grid grid-cols-1 md:grid-cols-3 bg-[#2b2b2b] gap-0 md:gap-1 relative top-0 md:-top-[10px] mb-8 md:mb-0 shadow-lg">
                ...
                <div class="col-span-1 p-4 border-b border-[#555555] md:border-b-0 md:border-r">
                    <div class="p-2 md:p-4 text-white text-center md:text-left">
                        <h2 class="text-2xl md:text-3xl font-bold mb-2 md:mb-4"><?php pll_e('s_tieu_de_tim_kiem'); ?>
                        </h2>
                        <div class="desc-find text-sm md:text-base text-gray-300">
                            <?php echo get_the_excerpt($current_page_id); ?>
                        </div>
                    </div>
                </div>

                <form role="search" method="get" action="<?php echo esc_url($page_url); ?>"
                    class="col-span-1 md:col-span-2 p-6 flex align-center justify-center items-center flex-col">
                    <div class="el-search flex align-center items-center w-full md:w-[80%] relative">
                        <input type="text" name="keyword" value="<?php echo esc_attr($keyword); ?>"
                            class="w-full px-4 py-3 md:py-4 bg-[#414141] text-white text-base outline-none focus:bg-[#505050] transition-colors rounded md:rounded-none"
                            placeholder="<?php pll_e('s_placeholder_tim_kiem'); ?>">
                        <button type="submit"
                            class="text-white absolute right-4 hover:text-yellow-500 transition-colors">
                    ...
                    <div class="w-full md:w-[80%] mt-2 text-center md:text-right">
                        <a class="col-span-1 py-2 md:py-4 text-[#b6b6b6] underline hover:text-white transition-colors text-sm"
            ...
            <div class="result-member">
                <?php if ($the_query->have_posts()): ?>
                    <h4 class="my-6 md:my-[3rem] text-lg font-medium text-gray-600">
                        <?php printf(pll__('Hiển thị %s ~ %s của %s kết quả'), $start_result, $end_result, $total_posts); ?>
                    </h4>
                    ...
                    <div class="list-member grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                        <?php while ($the_query->have_posts()):
                            ...
                            ?>
                            <div class="member-item my-0 md:my-3 group"> <a href="<?php the_permalink(); ?>"
                                    class="relative w-full block overflow-hidden">
                                    <img src="<?php echo esc_url($avatar); ?>" alt="<?php echo esc_attr($full_name); ?>"
                                    ...
                                    <div
                                        class="layer-gray absolute top-0 left-0 w-full h-full bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                ...
                                <div class="member-info my-3">
                                    <a href="<?php the_permalink(); ?>">
                                        <h3 class="text-[#125f4b] font-semibold text-xl md:text-2xl hover:underline">
                                    ...
                                    <div class="m-contact flex flex-wrap justify-between items-center gap-2">
                                        ...
                                        <div class="m-phone flex items-center">
                                            <?php if ($phone != ""): ?>
                                                <div class="flex items-center gap-2">
                                                    <i
                                                        class="fa-solid fa-phone w-8 h-8 flex items-center justify-center rounded-full bg-[#f1f1f1] hover:bg-[#125f4b] hover:text-white transition-colors text-sm"></i>
                                                    <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9]/', '', $phone)); ?>"
                                                        class="text-sm md:text-base hover:text-[#125f4b] transition-colors whitespace-nowrap">
                                        ...
                                        <div class="m-social flex gap-2">
                                            <?php if ($link_fb): ?>
                                                <a target="_blank" href="<?php echo esc_url($link_fb); ?>"><i
                                                        class="fa-brands fa-facebook w-8 h-8 flex items-center justify-center rounded-full bg-[#f1f1f1] hover:bg-[#125f4b] hover:text-white transition-colors text-sm"></i></a>
                                            <?php endif; ?>

                                            <?php if ($link_linkedin): ?>
                                                <a target="_blank" href="<?php echo esc_url($link_linkedin); ?>"><i
                                                        class="fa-brands fa-linkedin w-8 h-8 flex items-center justify-center rounded-full bg-[#f1f1f1] hover:bg-[#125f4b] hover:text-white transition-colors text-sm"></i></a>
                                            <?php endif; ?>

                                            <?php if ($email): ?>
                                                <a target="_blank" href="mailto:<?php echo esc_attr($email); ?>"><i
                                                        class="fa-solid fa-envelope w-8 h-8 flex items-center justify-center rounded-full bg-[#f1f1f1] hover:bg-[#125f4b] hover:text-white transition-colors text-sm"></i></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <div class="text-center py-10 md:py-20 my-6 md:my-[3rem] bg-gray-50 rounded-lg">
                        ...
                        <a href="<?php echo get_permalink(); ?>"
                            class="inline-block mt-4 text-[#125f4b] font-bold underline hover:text-black">
