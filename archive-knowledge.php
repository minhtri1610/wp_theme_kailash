    ...
    <div class="container mx-auto px-4">
        ...
        <?php if ( $the_query->have_posts() ) : ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                ...
                ?>
                    <article class="knowledge-card h-full flex flex-col bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-200">
                        ...
                        <a href="<?php the_permalink(); ?>" class="block relative overflow-hidden aspect-[16/9] flex-shrink-0">
                            ...
                            <?php else : ?>
                                <img src="https://dummyimage.com/600x400/f3f4f6/9ca3af&text=Kailash" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                            <?php endif; ?>
                            
                            <div class="absolute bottom-0 left-0 bg-[#125f4b] text-white text-xs font-bold px-3 py-1.5 rounded-tr-lg">
                        ...
                        <div class="p-5 md:p-6 flex-1 flex flex-col">
                            ...
                            <?php if( $related_exps ): ?>
                                <div class="flex flex-wrap gap-2 mb-3">
                                    <?php foreach($related_exps as $exp_id): ?>
                                        <span class="bg-gray-100 text-[#125f4b] text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">
                            ...
                            <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-3 line-clamp-2 leading-snug group-hover:text-[#125f4b] transition-colors">
                            ...
                            <?php if ( $post_tags ) : ?>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <?php foreach( $post_tags as $tag ) : ?>
                                        <a href="<?php echo get_tag_link( $tag->term_id ); ?>" class="text-[10px] text-gray-500 hover:text-[#125f4b] transition-colors italic">
                                            #<?php echo $tag->name; ?>
                                        </a>
                                    <?php endforeach; ?>
                                </div>
